...
import { getTopHeadlines } from "../resources/api";
import List from '../components/List';
import Loading from '../components/Loading';
import { View } from 'react-native';

// Set up list screen and connect to store
class ListTopHeadlinesScreen extends Component {
...
ListTopHeadlinesScreen.navigationOptions = {
...
const mapDispatchToProps = dispatch => {
    return {
       onLoad: () => dispatch(getTopHeadlines()),
    };
};

export default connect(mapStateToProps, mapDispatchToProps)(ListTopHeadlinesScreen);
